  ...
  it("generates the code and derives flags on the server", async () => {
    ...
    expect(prisma.product.create).toHaveBeenCalledWith({
      data: expect.objectContaining({
        ...
        targetRetailPriceIncludingVat: 1.8333,
        fixedRetailPriceIncludingVat: 20,
        appliedRetailPriceIncludingVat: 20,
        appliedRetailPriceExcludingVat: 18.1818,
        profitPerUnit: 17.6818,
        actualMarginPercentage: 97.25,
        percentagePointDeviation: 27.25,
        unitDifference: 18.1667,
        pricingDiagnosis: "POR ENCIMA",
        createdById: "user-1",
      }),
    })
