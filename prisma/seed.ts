...
async function main() {
  ...
  const catalogos = [
    ...
    { tipo: "FAMILIA", valor: "Harinas y sémolas", descripcion: "Harinas, sémolas y cereales" },
    { tipo: "FAMILIA", valor: "Levaduras y mejorantes", descripcion: "Levaduras, mejorantes y premezclas" },
    { tipo: "FAMILIA", valor: "Azúcares y edulcorantes", descripcion: "Azúcares, miel, edulcorantes" },
    { tipo: "FAMILIA", valor: "Grasas y aceites", descripcion: "Mantequilla, margarina, aceites" },
    { tipo: "FAMILIA", valor: "Lácteos y huevos", descripcion: "Leche, nata, queso, huevo" },
    { tipo: "FAMILIA", valor: "Frutas y frutos secos", descripcion: "Fruta fresca, frutos secos, confitura" },
    { tipo: "FAMILIA", valor: "Chocolates y coberturas", descripcion: "Chocolate, coberturas, cacao" },
    { tipo: "FAMILIA", valor: "Aditivos y aromas", descripcion: "Colorantes, aromas, gelificantes" },
    { tipo: "FAMILIA", valor: "Sal y especias", descripcion: "Sal, pimienta, especias" },
    { tipo: "FAMILIA", valor: "Envases y embalajes", descripcion: "Bolsas, cajas, bandejas, etiquetas" },
    { tipo: "FAMILIA", valor: "Consumibles y limpieza", descripcion: "Productos de limpieza y consumibles" },
    { tipo: "FAMILIA", valor: "Pan", descripcion: "Panes y variaciones" },
    { tipo: "FAMILIA", valor: "Bollería", descripcion: "Croissants, napolitanas, magdalenas" },
    { tipo: "FAMILIA", valor: "Pastelería", descripcion: "Pastelería en general" },
    { tipo: "FAMILIA", valor: "Tartas", descripcion: "Tartas enteras y porciones" },
    { tipo: "FAMILIA", valor: "Salados", descripcion: "Empanadas, bocadillos, etc." },
    { tipo: "FAMILIA", valor: "Bebidas", descripcion: "Agua, refrescos, zumos" },
    { tipo: "FAMILIA", valor: "Cafetería", descripcion: "Café y productos de cafetería" },
    { tipo: "FAMILIA", valor: "Semielaborados", descripcion: "Masas, cremas, bizcochos del obrador" },
